...
<h1>session attendance Form</h1>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO session_attendance (Attendance_ID,Workshop_ID,Attendee_ID) VALUES (?, ?, ?)");
        $stmt->bind_param("iii", $Attendance_ID,$Workshop_ID,$Attendee_ID);
...
?>
<h2>Data for resources usage Form</h2>
    <table border="1">
        <tr>
            <th>Attendance ID</th>
            <th>Workshop ID</th>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td><a style='padding:2px' href='delete_session_attendance.php?Attendance_ID=$Attendance_ID'>Delete</a></td> 
                    <td><a style='padding:2px' href='update_session_attendance.php?Attendance_ID=$Attendance_ID'>Update</a></td> 
                </tr>";
            }
        } else {
